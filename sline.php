...
$httpClient = new __DIR__.\LINE\LINEBot\HTTPClient\CurlHTTPClient($access_token);
$bot = new __DIR__ .\LINE\LINEBot($httpClient, ['channelSecret' => '75584d370097584887a2b1e843de141c']);
